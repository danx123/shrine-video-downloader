...
# ADDED: Worker untuk aktivasi DNS agar tidak memblokir UI
class DnsWorker(QObject):
    finished = pyqtSignal(bool, str, str) # success_status, dns_server, error_message
...
class ShrineDownloader(QWidget):
    ...
    def setup_threads(self):
        ...
        # ADDED: Threading untuk DNS worker
    ...
    def fetch_metadata(self):
        ...
        if not url: return
        self.meta_thread.started.connect(lambda: self.meta_worker.run(url))
    ...
    def start_next_in_batch(self):
        ...
        # FIX: Hapus pengambilan judul yang memblokir UI.
        # Biarkan yt-dlp yang menentukan nama file secara otomatis.
        base_cmd = [
        ...
        if download_format == "Audio (MP3)":
            # Template nama file: JudulVideo.mp3
            ...
            # Template nama file: JudulVideo_720p.mp4
    ...
    # FIX: Pindahkan proses aktivasi DNS ke background thread
    ...
    # ADDED: Slot untuk menangani hasil dari DnsWorker
    ...
    def closeEvent(self, event):
        ...
        # Pastikan semua thread berhenti
